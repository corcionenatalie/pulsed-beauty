 ...
 *
 * ✅ Easiest to edit:
 *   - Update everything in the CONTENT blocks below (BRAND, SERVICES, PRICING, FAQ, POLICIES)
 * ✅ Modern + clean + bright & welcoming
 * ✅ Multi-page routing via react-router-dom
 *
 * To use multi-page routing in a real deploy:
 * - Vercel/Netlify: works out of the box, but ensure SPA fallback/rewrites are set.
 */
...
const BRAND = {
  ...
  bookingUrl: "https://your-booking-link.com", // TODO: paste your booking link
...
const SERVICES = [
  {
    ...
    note:
      "Best results come from a series. Ask about packages during your consult.",
  },
  {
    id: "sculpt",
    ...
    note:
      "Not a weight-loss substitute—ideal for contouring and tightening goals.",
  },
  {
    id: "whiten",
    ...
    note:
      "Avoid dark foods/drinks for 24 hours post-treatment for best results.",
  },
  {
    id: "pmu",
    ...
    note:
      "A patch test may be recommended. Healing time varies by service.",
  },
  {
    id: "facials",
    title: "Facials",
    ...
    note:
      "Perfect monthly reset—ask about memberships or bundles.",
  },
];

// Simple, easy pricing you can edit anytime.
// If you don’t want pricing public, set showPricing = false.
const PRICING = {
  showPricing: true,
  note:
...
function PrimaryButton({ href, children, className, onClick }) {
  ...
  return (
    <Tag
      {...props}
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-full bg-neutral-900 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:opacity-90",
        className
      )}
    >
    ...
    >
      {kicker ? (
        <div className={cn(align === "center" ? "flex justify-center" : "")}>
          <span className="mb-3 inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-4 py-1 text-xs tracking-wide text-neutral-700">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-neutral-50 to-white text-neutral-900">
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0">
        <div className="absolute -top-52 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-amber-100/55 blur-[120px]" />
        <div className="absolute bottom-[-220px] left-[-160px] h-[520px] w-[520px] rounded-full bg-rose-100/55 blur-[130px]" />
        <div className="absolute right-[-220px] top-[20%] h-[520px] w-[520px] rounded-full bg-sky-100/55 blur-[130px]" />
      </div>
      ...
      <Container className="flex items-center justify-between gap-4 py-3">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="hidden rounded-full border border-neutral-200 bg-white px-4 py-2 text-sm font-semibold text-neutral-900 transition hover:bg-neutral-50 md:inline-flex"
          >
            Book
          </a>
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          ...
          isActive ? "bg-neutral-900 text-white" : "text-neutral-900"
        )
      }
      end={to === "/"}
    >
        ...
        <Container className="grid items-center gap-10 pb-12 pt-14 md:grid-cols-2 md:pb-16 md:pt-16">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-4 text-sm text-neutral-600">
              ...
              <div className="inline-flex items-center gap-2">
                <Calendar className="h-4 w-4" /> {BRAND.hoursLine}
              </div>
            </div>
          </div>
              ...
              <div className="relative aspect-[4/3] w-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="rounded-full border border-neutral-200 bg-white px-3 py-1 text-xs text-neutral-700">
                      Consult-first
                    </div>
                  </div>
              ...
              >
                <GlassCard className="p-6">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="hidden sm:flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-3 py-1 text-xs text-neutral-700">
                      <Sparkles className="h-3.5 w-3.5" />
                      Results-focused
                    </div>
                  </div>
                  ...
                  <div className="mt-5 grid gap-3 sm:grid-cols-2">
                    {selected.bullets.map((b) => (
                      ...
                      >
                        <Check className="mt-0.5 h-4 w-4 text-neutral-800" />
      ...
      <Container className="py-12">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-12">
          <GlassCard className="md:col-span-7 p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-neutral-600">
              We focus on high-impact services—laser hair removal, body sculpting,
              teeth whitening, permanent makeup, and facials—so your routine stays
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
                {
                  title: "Consult-first",
                  desc: "We customize every plan and set realistic timelines.",
                },
                {
                  title: "Comfort-forward",
                  desc: "Clear steps, guidance, and aftercare you can actually follow.",
                },
                {
                  title: "Natural finish",
                  desc: "Enhancement that still looks like you—just elevated.",
                },
                {
                  title: "Bright space",
                  desc: "Clean, airy, and designed to feel welcoming.",
                },
              ].map((p) => (
                <div
                  key={p.title}
          ...
          <GlassCard className="md:col-span-5 p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-neutral-600">
              Drop in your bio here (credentials, training, specialties), plus a
              short mission statement.
            </p>
            <div className="mt-4 rounded-2xl border border-neutral-200 bg-white p-4">
              <div className="text-xs font-semibold text-neutral-900">Prompt</div>
              <div className="mt-1 text-sm text-neutral-600">
                “I started Pulsed Beauty because…”
              </div>
            </div>
            <div className="mt-5 flex flex-col gap-3">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-neutral-200 bg-white px-5 py-2.5 text-sm font-semibold text-neutral-900 transition hover:bg-neutral-50"
              >
    ...
    <PageShell title="FAQ">
      <Container className="py-12">
        <SectionTitle
          ...
          subtitle="If you don’t see your question here, message us and we’ll help you pick the right service."
        />
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-12">
          ...
          <GlassCard className="md:col-span-5 p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-neutral-600">
              Clear expectations keep things smooth for everyone.
            </p>
            <div className="mt-4 space-y-3">
              {[{ t: "Cancellation", d: POLICIES.cancellation }, { t: "Late policy", d: POLICIES.late }, { t: "Results", d: POLICIES.results }].map(
                (p) => (
                  <div
                    key={p.t}
                    className="rounded-2xl border border-neutral-200 bg-white p-4"
      ...
      <Container className="py-12">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-12">
          ...
          <GlassCard className="md:col-span-6 p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-neutral-600">
              This form is a ready-to-wire UI. To make it actually send emails,
              connect it to Formspree, Netlify Forms, or your backend.
            </p>
            ...
            >
              ...
              <select className="h-11 w-full rounded-xl border border-neutral-200 bg-white px-4 text-sm text-neutral-800 outline-none focus:border-neutral-400">
                {[
              ...
              <textarea
                className="min-h-[120px] w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-900 placeholder:text-neutral-400 outline-none focus:border-neutral-400"
...
function InfoRow({ icon: Icon, title, subtitle }) {
  return (
    <div className="flex items-start gap-3">
      <div className="grid h-10 w-10 place-items-center rounded-xl border border-neutral-200 bg
